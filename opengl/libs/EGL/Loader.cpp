        ...
        egl_connection_t* cnx, uint32_t mask)
{
    ...
    private:
        static bool find(String8& result,
            ...
            char  isAndroidRenderer[PROPERTY_VALUE_MAX];
            property_get("ro.config.use.android_renderer", isAndroidRenderer, "false");
            if (checkGlesEmulationStatus() == 0 || !strcmp(isAndroidRenderer, "true")) {
